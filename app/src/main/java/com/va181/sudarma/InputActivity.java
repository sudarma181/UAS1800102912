...
public class InputActivity extends AppCompatActivity {
    ...
    private EditText editFirstName, editLastName, editPhoneNumber, editNameBook, editEmail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editNameBook = findViewById(R.id.edit_name_book);
        ...
        if(data.getString("OPERATION").equals("insert")) {
            ...
            editNameBook.setText(data.getString("NAME_BOOK"));
        ...
        switch(view.getId()) {
            case R.id.jekel_laki:
                if (checked) {
                    ...
                    imgLocation = ApiClient.IMAGE_URL + " ";
                    break;
                }
    ...
    private void saveData() {
        ...
        String nameBook = editNameBook.getText().toString();
        ...
        if(!(firstName.equals("") && lastName.equals("") && number.equals(""))) {
            ...
            if(updateOperation == false) {
                call = api.addData(firstName, lastName, number, nameBook, email, imgLocation, gender);
            } else {
                call = api.editData(String.valueOf(id), firstName, lastName, number, nameBook, email, imgLocation, gender);
                updateOperation = false;
            }
